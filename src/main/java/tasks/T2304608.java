...
/**
 * Created by oleg on 09.12.2020.
 */
public class T2304608 extends Task{
    String taskId;
    WebDriver driver;
    NavigatorHelper navigatorHelper;

    public T2304608(String taskId, WebDriver driver) {
        this.taskId = taskId;
        this.driver = driver;
    ...
    public StringBuilder work(Logger log) {
        String linkFacebook = "https://tinyurl.com/qomdnkm";
    ...
    public StringBuilder workByTask(Logger log) {
        ...
        String url = "(//a[contains(@href, 'https://l.facebook.com/l.php')])[2]";
